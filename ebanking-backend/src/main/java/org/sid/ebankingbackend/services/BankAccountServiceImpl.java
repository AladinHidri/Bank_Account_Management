...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, Long customerId) throws CustomerNotFoundException {
        ...
        currentAccount.setCreatredAt(new Date());
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interstRate, Long customerId) throws CustomerNotFoundException {
        ...
        savingAccount.setCreatredAt(new Date());
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        List<AccountOperationDTO> accountOperationsDTO = accountOperations.stream().map(op -> dtoMapper.fromAccountOperation(op)).collect(Collectors.toList());
        accountHistoryDTO.setAccountOperationDTOS(accountOperationsDTO);
        accountHistoryDTO.setAccountId(bankAccount.getId());
        accountHistoryDTO.setBalance(bankAccount.getBalance());
        accountHistoryDTO.setCurrentOage(page);
